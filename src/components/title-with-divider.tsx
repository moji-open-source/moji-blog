...
export function TitleWithDivider({ title, number }: Props) {
  return <h5 className="flex items-center whitespace-nowrap mb-10 text-xl">
    {title}
    <span data-number={number} className="relative ml-5 mr-[35px] inline-block h-[1px]
     ...
     after:top-[-6px] after:right-[-35px]"></span>
  </h5>
}